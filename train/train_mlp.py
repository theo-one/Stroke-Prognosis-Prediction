...
writer = SummaryWriter("./result/mlp_loss")
    ...
    def train(self):
        for epoch in range(self.num_epochs):
            ...
            for inputs, labels in tqdm(self.train_dataloader, desc=f"Epoch: {epoch}/{self.num_epochs}"):
                ...
                # writer.add_histogram(f'Gradients/fc2', self.model.fc2.weight.grad, epoch)
            ...
            if avg_val_loss < self.best_loss:
                ...
                torch.save(self.model.state_dict(), f'./result/modelBest/mlp_{self.num}_modelBestParameters')
                self.early_stopping = 0
            else:
